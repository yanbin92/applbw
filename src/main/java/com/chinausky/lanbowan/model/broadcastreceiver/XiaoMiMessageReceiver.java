package com.chinausky.lanbowan.model.broadcastreceiver;
...
public class XiaoMiMessageReceiver extends PushMessageReceiver {
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        Log.w(TAG, "onReceivePassThroughMessage is called. " + message.toString());
    ...
    public void onNotificationMessageClicked(Context context, MiPushMessage message) {
        Log.w(TAG, "onNotificationMessageClicked is called. " + message.toString());
    ...
    public void onNotificationMessageArrived(Context context, MiPushMessage message) {
        Log.w(TAG, "onNotificationMessageArrived is called. " + message.toString());
    ...
    public void onCommandResult(Context context, MiPushCommandMessage message) {
        Log.w(TAG, "onCommandResult is called. " + message.toString());
...
//                log = context.getString(R.string.set_accept_time_fail, message.getReason());
    ...
    public void onReceiveRegisterResult(Context context, MiPushCommandMessage message) {
        Log.w(TAG, "onReceiveRegisterResult is called. " + message.toString());
        String command = message.getCommand();
        List<String> arguments = message.getCommandArguments();
        String cmdArg1 = ((arguments != null && arguments.size() > 0) ? arguments.get(0) : null);
        String log;

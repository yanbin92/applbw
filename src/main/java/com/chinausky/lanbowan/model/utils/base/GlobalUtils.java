...
//	}
    ...
    public static View convertViewFromXml(Context context, int xml, ViewGroup parent, boolean attachToRoot) {
        ...
        View view = layoutInflater.inflate(xml, parent, attachToRoot);

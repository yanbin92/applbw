...
public class RealTimeActivity extends BaseActivity implements OnClickListener, OnWorkerListener {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            Toast.makeText(RealTimeActivity.this, "现在是竖屏", Toast.LENGTH_SHORT).show();
        }

        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            Toast.makeText(RealTimeActivity.this, "现在是横屏", Toast.LENGTH_SHORT).show();
    ...
    private void logout() {
        ...
        builder.setPositiveButton("确认",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        APP.ShowWorking(RealTimeActivity.this, "登出中...", 1);
                    }
                });
